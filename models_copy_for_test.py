...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    def referral_link(self):
        ...
        try:
            register_path = reverse("sign-up")  # Ensure you have a 'register' named url
        except:
            register_path = "/api/auth/sign-up/"
        return f"{base_url}{register_path}?ref={self.referral_code}"
